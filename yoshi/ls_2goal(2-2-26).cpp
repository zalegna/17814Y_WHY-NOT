...
void autonomous() {
	...
	startOdom();
	scoreBlocker.set_value(true);
	bottomStage.move_velocity(600);
	moveForward(18, 3.5);
	midStage.move_velocity(800);
	turnLeft(15);
	pros::delay(100);
	moveForward(13, 3);
	...
	// //Go to middle goal
	turnLeft(88, 6);
	moveBackwards(19.5, 4);
	scoreBlocker.set_value(false);
	topStage.move_velocity(-200);
	bottomStage.move_velocity(600);
	midStage.move_velocity(200);
	pros::delay(1500);
	bottomStage.move_velocity(0);
	topStage.move_velocity(0);
	midStage.move_velocity(0);
	...
	// moveBackwards(10, 8);
	// turnLeft(10);
	moveBackwards(30, 6.75);
	scoreBlocker.set_value(false);
	topStage.move_velocity(600);
	bottomStage.move_velocity(600);
	midStage.move_velocity(600);
}
